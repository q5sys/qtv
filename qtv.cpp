...
qtv::qtv(QWidget *parent) : QMainWindow(parent), ui(new Ui::qtv){
  ui->setupUi(this);
...
void qtv::on_dirview_clicked(const QModelIndex &index){
...
void qtv::on_fileview_clicked(const QModelIndex &index){
